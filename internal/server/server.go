...
func authenticate(ctx context.Context) (context.Context, error) {
	...
	// Extract Common Name from the certificate that is used
	// to establish TLS connection between the client and the server
	// and use the Common Name as the subject to control access to
	// a resource

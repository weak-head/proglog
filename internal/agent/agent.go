...
import (
	...
	"github.com/weak-head/proglog/internal/auth"
	"github.com/weak-head/proglog/internal/discovery"
...
func (a *Agent) setupMux() error {
	...
	// The listener accepts both gRPC and Raft connections
...
func (a *Agent) setupLog() error {
	// Listener that matches Raft connections
	raftLn := a.mux.Match(
...
func (a *Agent) setupServer() error {
	...
	// Listener that matches any connections
